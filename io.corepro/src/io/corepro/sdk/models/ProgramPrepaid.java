...
public class ProgramPrepaid {
    ...
    public Boolean getIsImmediateLoadFromLinkedAccountEnabled() {
        return isImmediateLoadFromLinkedAccountEnabled;
    }

    public void setIsImmediateLoadFromLinkedAccountEnabled(Boolean isImmediateLoadFromLinkedAccountEnabled) {
        this.isImmediateLoadFromLinkedAccountEnabled = isImmediateLoadFromLinkedAccountEnabled;
    }
}